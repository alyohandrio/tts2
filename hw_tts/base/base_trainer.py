...
from hw_tts.base import BaseGenerator, BaseDiscriminator
...
class BaseTrainer:
    ...
    def __init__(self, generator: BaseGenerator, msd: BaseDiscriminator, mpd: BaseDiscriminator, criterion, metrics, optimizer_g, optimizer_d, config, device):
        self.device = device
        self.config = config
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if checkpoint["config"]["generator_arch"] != self.config["generator_arch"] or checkpoint["config"]["msd_arch"] != self.config["msd_arch"] or checkpoint["config"]["mpd_arch"] != self.config["mpd_arch"]:
            self.logger.warning(
